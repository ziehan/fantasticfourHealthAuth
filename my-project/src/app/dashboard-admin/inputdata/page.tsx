...
import { ArrowRightIcon, DocumentPlusIcon } from '@heroicons/react/24/outline'; // Menggunakan DocumentPlusIcon untuk submit
...
const formFieldsConfig = [
  { name: "id_kunjungan_pasien", label: "ID Kunjungan Pasien", type: "text", required: true, span: "md:col-span-1" },
  { name: "id_pasien_internal", label: "ID Pasien Internal", type: "text", required: false, span: "md:col-span-1" },
  { name: "id_faskes", label: "ID Faskes", type: "text", required: true, span: "md:col-span-1" },
  { name: "tanggal_jam_kunjungan", label: "Tgl & Jam Kunjungan", type: "datetime-local", required: true, span: "md:col-span-1" },
  { name: "tempat_lahir", label: "Tempat Lahir", type: "text", required: true, span: "md:col-span-1" },
  ...
  { name: "domisili_pasien", label: "Domisili (Kelurahan/Desa)", type: "text", required: true, span: "md:col-span-1" },
  { name: "keluhan_utama_pasien", label: "Keluhan Utama Pasien", type: "textarea", required: true, rows: 3, span: "md:col-span-2" },
  { name: "gejala_fisik_dialami", label: "Gejala Fisik Dialami", type: "textarea", required: true, rows: 3, span: "md:col-span-2" },
  { name: "tanggal_onset_gejala_pertama", label: "Tgl Onset Gejala Pertama", type: "date", required: true, span: "md:col-span-1" },
  { name: "suhu_tubuh", label: "Suhu Tubuh (°C)", type: "number", required: true, step: "0.1", span: "md:col-span-1" },
  { name: "dugaan_penyakit", label: "Dugaan Penyakit", type: "text", required: true, span: "md:col-span-2" },
  { name: "riwayat_penyakit_penyerta_komorbid", label: "Riwayat Penyakit Penyerta/Komorbid", type: "textarea", required: false, rows: 2, span: "md:col-span-2" },
  ...
  { name: "riwayat_perjalanan_14_hari_terakhir", label: "Riwayat Perjalanan 14 Hari Terakhir", type: "textarea", required: true, rows: 2, span: "md:col-span-2" },
  { name: "hasil_pemeriksaan_penunjang_kunci", label: "Hasil Pemeriksaan Penunjang Kunci", type: "textarea", required: false, rows: 2, span: "md:col-span-2" },
  { name: "tindakan_yang_diberikan", label: "Tindakan yang Diberikan", type: "textarea", required: true, rows: 3, span: "md:col-span-2" },
];
