...
const DashboardNakesPage: React.FC = () => {
  ...
  return (
    <>
      ...
      <section className="min-h-screen h-auto flex flex-col items-center justify-center bg-[#E0F2F3] p-6 sm:p-8">
      ...
      <section className="min-h-screen h-auto flex flex-col items-center justify-center bg-[#A0D0D5] p-6 sm:p-8">
      ...
      <section className="min-h-screen h-auto flex flex-col items-center bg-[#1E47A0] p-6 sm:p-8 pt-10 sm:pt-12 md:pt-16">
